...
public class ImageUtils {
    ...
    public static Uri saveBitmapToFile(@NonNull final Context context,
            @NonNull final Bitmap image, @NonNull final String author,
            @NonNull final String name, @NonNull final int step) {
        BufferedOutputStream stream = null;
        File file;
        try {
            file = FileUtils.createJpgFile(context, author, name, step);
